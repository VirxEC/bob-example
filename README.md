...
1. Install [bob](https://github.com/swz-git/bob)
2. Clone this repo: `git clone https://github.com/swz-git/bob-examples`
3. Change directory into the repo: `cd bob-examples`
4. Build! `bob build bob.toml`
